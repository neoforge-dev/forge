...
type RaceConfig struct {
    ...
    NodeAffinity         []string      // ["nova", "sati"] - never prya
...
|------|-----|--------|----------|----------------|
| prya | 16 GB | 4 | ~9 GB | ❌ No (CC overhead) |
| sati | 64 GB | 7 | ~57 GB | ✅ Yes |
| nova | 48 GB | 2-3 | ~45 GB | ✅ Yes (best) |
| vega | 16 GB | 2 | ~15 GB | ⚠️ Limited |
