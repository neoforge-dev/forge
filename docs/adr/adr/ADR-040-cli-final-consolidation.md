...
| `forged-start-node-1` | `forge daemon start` |
| `forged-restart` | `forge daemon restart` |
| `forge-fleet` | `forge fleet` |
| `forge-monitor` | `forge monitor` |
| `forge-v3-start-node-5` / `forge-v3-start-node-3` | `forge fleet spawn <agent>` |
...
| `forge-v3-deploy-node-3` | REVIEW | covered by `forge node join`? |
| `forge-v3-mesh-status` | DELETE | `forge node list` |
| `forge-v3-start-node-5` | DELETE | `forge fleet spawn` |
| `forge-v3-start-node-3` | DELETE | `forge fleet spawn` |
| `forged-logs` | DELETE | `tail -f /tmp/forged.log` or `forge daemon logs` |
| `forged-restart` | DELETE | `forge daemon restart` |
| `forged-start-node-1` | DELETE | `forge daemon start` |
