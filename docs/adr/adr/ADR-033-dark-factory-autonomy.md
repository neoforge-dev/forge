...
**Status:** 📋 PROPOSED
**Date:** 2026-03-06
**Source:** Council audit (3 agents) — node-1 S70 session
**Deciders:** node-1 lead orchestrator
...
|---------|-------|--------|---------|
| Auto-Promote Patrol | node-2 fleet agent | 1-2 hrs | None |
| Result File Monitor | node-2 fleet agent | 1-2 hrs | None |
| Confidence Scoring | node-2 lead or kimi | 3-4 hrs | Features 1+2 first |
