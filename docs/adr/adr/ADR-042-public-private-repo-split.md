...
**Date:** 2026-03-10
**Status:** Proposed
**Decision Makers:** Lead orchestrator (node-1), council review deferred
...
### Private Repository: `github.com/neoforge-dev/forge-ops` (or similar)
...
2. Push current state of business paths to `forge-ops` private repo:
   ...
   git remote add origin git@github.com:neoforge-dev/forge-ops.git
   git push -u origin main
   ```

3. Add `forge-ops` as submodule in the private checkout:
   ```bash
   git submodule add git@github.com:neoforge-dev/forge-ops.git ops
   ```
