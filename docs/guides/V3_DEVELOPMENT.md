...
> **LEGACY — Historical reference only (ADR-040, 2026-03-09).** The `forge-v3` binary and Python CLI v2 were replaced by `cmd/forge/` (Go CLI v4) and `cmd/forged/` (daemon). See `docs/INFRASTRUCTURE_MAP.md` for current setup.
...
- Default database path (from `docs/v3/GETTING_STARTED.md`):  
  - `/home/bogdan/FORGE/.forge/forge-v3.db`
...
export DB_PATH="/home/bogdan/FORGE/.forge/forge-v3.db"
...
- Database (default): `/home/bogdan/FORGE/.forge/forge-v3.db`
- XNode inbox: `/home/bogdan/FORGE/.forge/xnode/lead-inbox`
- XNode acks: `/home/bogdan/FORGE/.forge/xnode/acks`
- Context: `/home/bogdan/FORGE/.forge/context`
...
```bash
cd /home/bogdan/FORGE/cmd/forge-v3
go build -o forge-v3 .
