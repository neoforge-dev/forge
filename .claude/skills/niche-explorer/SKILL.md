...
3. Run `forge loop run` to start building
4. Track in Command Center

---

**Output Path**: `{domain}/explorations/{mvp-name}-exploration.md`
```
...
- [ ] Market size estimates with reasoning
- [ ] Clear differentiation from competitors
- [ ] Specific target user personas
- [ ] Measurable success metrics
- [ ] Tech stack alignment with domain standards
...
Domain: babybit-es
Focus: baby nutrition tracking
Constraints:
- COPPA compliant (parents are account owners)
- Integrates with existing meal-planner project
- Target Spanish-speaking families
```

## Related Skills

- `/mvp-spec-writer` - Convert exploration to features.json
- `/living-docs` - Update domain strategy with findings
- `forge loop run` - Start building the MVP
