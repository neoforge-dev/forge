...
// ---------------------------------------------------------------------------
// main.go — stub handlers (return 501)
// ---------------------------------------------------------------------------

func TestHandleGitGuard_NotImplemented(t *testing.T) {
	req := httptest.NewRequest(http.MethodGet, "/cli/git/guard", nil)
	w := httptest.NewRecorder()
...
func TestHandleGitStatus_NotImplemented(t *testing.T) {
...
func TestHandleFleetStatus_NotImplemented(t *testing.T) {
	req := httptest.NewRequest(http.MethodGet, "/cli/fleet/status", nil)
	w := httptest.NewRecorder()
...
func TestHandleFleetTopologyNotImplementedW18(t *testing.T) {
...
func TestHandleAgentSpawn_NotImplemented(t *testing.T) {
...
func TestHandleAgentStop_NotImplemented(t *testing.T) {
	req := httptest.NewRequest(http.MethodPost, "/cli/agent/stop", nil)
	w := httptest.NewRecorder()
...
func TestHandleSystemPatrol_NotImplemented(t *testing.T) {
...
func TestHandleSystemMetrics_NotImplemented(t *testing.T) {
